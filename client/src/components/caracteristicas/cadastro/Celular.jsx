...
export default function Celular({
  ...
  const campos = ["ram", "armazenamento", "mac", "numeros", "local"];
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div>
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1">
            <label className="text-sm text-white/70">Números Conectados</label>
            <span className="text-xs text-red-400">*</span>
          </div>
          <span className="text-xs text-white/50">
            {contadores.numeros}/50
          </span>
        </div>
        <input
          type="text"
          ...
          onChange={(e) => handleChange("numeros", e.target.value, 50)}
          className="w-full rounded-lg bg-white/10 px-3 py-2 text-sm text-white 
                     placeholder-white/40 ring-1 ring-white/10 
                     focus:outline-none focus:ring-2 focus:ring-sky-500/60"
        />
      ...
      <div>
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1">
            <label className="text-sm text-white/70">Local</label>
            <span className="text-xs text-red-400">*</span>
          </div>
          <span className="text-xs text-white/50">{contadores.local}/50</span>
        </div>
        <input
          type="text"
          maxLength={50}
          placeholder="Ex.: Deixado na empresa"
          onChange={(e) => handleChange("local", e.target.value, 50)}
          className="w-full rounded-lg bg-white/10 px-3 py-2 text-sm text-white 
                     placeholder-white/40 ring-1 ring-white/10 
                     focus:outline-none focus:ring-2 focus:ring-sky-500/60"
        />
