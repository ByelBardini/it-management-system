    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      <div className="md:col-span-2">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-xs text-white/50">{contadores.tipo}/100</span>
        </div>
        <input
          type="text"
          maxLength={100}
          placeholder="Ex.: Placa de Vídeo GTX1080 Ti, Memória RAM 8 GB DDR4..."
          onChange={(e) => handleChange("tipo", e.target.value, 100)}
